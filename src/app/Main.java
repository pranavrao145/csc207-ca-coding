...
public class Main {
    public static void main(String[] args) {
        ...
        JDialog clearDialog = new ClearView(clearViewModel);
        clearDialog.setVisible(false);
        clearDialog.setDefaultCloseOperation(JDialog.HIDE_ON_CLOSE);
        ...
        new ViewManager(views, cardLayout, clearDialog, viewManagerModel);
